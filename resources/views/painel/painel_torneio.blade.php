                ...
                <div class="container-fluid">
                    <div class="row my-2">
                        <div class="col-12">
                            ...
                            <button class="btn btn-outline-danger" onclick="resetarDestaques()" title="Resetar destaques"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-octagon" viewBox="0 0 16 16">
                        ...
                        <div class="col-12">
                            <table class="table table-striped" id="tabela" ondrop="dropDestaque(event)"
                                ...
                                <tbody id="tabelaDrop">
                                    ...
                                    <tr id="{{ $destaque->id }}" ondragstart="inicioArrastaDestaque(event)" ondragend="fimArrasta(event)" ondrop="ordenarDestaque(event)" ondragover="permitirDrop(event)" draggable="true">
                                        <td>{{ $destaque->titulo }}</td>
                                        <td>{{ $destaque->data }}</td>
                                        <td>{{ $destaque->cidade }} - {{ $destaque->sigla }}</td>
                                        <td>
                                            <button type="button" title="Apagar destaque" class="btn btn-danger" onclick="apagarDestaque(this)"><svg
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody id="tabelaDrag">
                                ...
                                @foreach ($campeonatos as $campeonato)
                                    <tr ondragstart="inicioArrastaTabela(event)" ondragend="fimArrasta(event)" draggable="true" id="{{ $campeonato->id }}">
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('painel-torneios.show', ['painel_torneio' => $campeonato->id]) }}"><button
                                                    title="Detalhes" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            <a
                                                href="{{ route('painel-torneios.edit', ['painel_torneio' => $campeonato->id]) }}"><button
                                                    title="Editar torneio" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16"
