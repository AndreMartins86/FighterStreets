...
class PainelTorneioController extends Controller
{
    ...
    public function chavesDetalhes($id, $sexo, $peso, $faixa): View
    {
        ...
        $btn = Chave::btnEncerrar($campeonato, $sexo, $peso, $faixa);
        //dd($chaves);

        return view('painel.chave_detalhes', compact('campeonato', 'chaves', 'contadorChaves', 'btn'));
    }
    ...
    {        
        ...
        // http://127.0.0.1:8000/resultados/10
